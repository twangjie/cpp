...
#ifndef QC_NET_UnknownHostException_h
#define QC_NET_UnknownHostException_h
...
class QC_NET_PKG UnknownHostException : public IOException
{
public:
...
#endif //QC_NET_UnknownHostException_h
