...
#ifndef QC_IO_PosixFileSystem_h
#define QC_IO_PosixFileSystem_h
...
class QC_IO_PKG PosixFileSystem : public FileSystem
{
public:
...
private:
	...
	static ByteString GetPosixFilename(const String& path);
	static void TranslateCodeToException(int errCode, const String& msg);
};

QC_IO_NAMESPACE_END

#endif //QC_IO_PosixFileSystem_h
