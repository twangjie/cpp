...
#ifndef QC_NET_Authenticator_h
#define QC_NET_Authenticator_h
...
public:
	...
	static bool RequestPasswordAuthentication(InetAddress* pAddr, int port,
...
protected:
	virtual bool getPasswordAuthentication(InetAddress* pAddr, int port,
		const String& protocol, const String& prompt, const String& scheme,
		bool bProxy, String& userRet, String& passwordRet)=0;

private:
	static Authenticator* QC_MT_VOLATILE s_pAuthenticator;
};

QC_NET_NAMESPACE_END

#endif //QC_NET_Authenticator_h
