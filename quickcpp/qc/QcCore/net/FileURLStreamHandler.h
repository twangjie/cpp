...
#ifndef QC_NET_FileURLStreamHandler_h
#define QC_NET_FileURLStreamHandler_h
...
class QC_NET_PKG FileURLStreamHandler : public URLStreamHandler
{
protected:
...
#endif //QC_NET_FileURLStreamHandler_h
