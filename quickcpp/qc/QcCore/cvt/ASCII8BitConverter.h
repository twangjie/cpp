...
// Overview
// --------
// Provides a version of a CodeConverter that can encode/decode ASCII-based
// 8-bit byte streams.
//
//=============================================================================

#ifndef QC_CVT_ASCII8BitConverter_h
#define QC_CVT_ASCII8BitConverter_h
...
class ASCII8BitConverter : public CodeConverter
{
...
public:
	...
	ASCII8BitConverter(const String& name,
...
#endif //QC_CVT_ASCII8BitConverter_h
